...
## Overview
Generates a package from a swagger spec file that can be imported by a [Vapor 4](https://vapor.codes) project. The package will contain a routes.swift, protocols to implement the APIs and data models.
