...
public class SwiftVapor3CodegenTest {
  ...
  public void allTest() throws InterruptedException, IOException {
    ...
    SwaggerCodegen.main(new String[]{"generate", "-l", "SwiftVapor3", "-i", "AllTest/codegen_test.yml", "-o", "./target/test-classes/AllTest/VaporTestInterface", "--additional-properties", "projectName=VaporTestInterface"});
...
//    pb.directory(new File("./target/test-classes/AllTest/VaporTestServer"));
  ...
  public void withoutAuthenticationTest() throws InterruptedException, IOException {
    //Build from the test swagger
    SwaggerCodegen.main(new String[]{"generate", "-l", "SwiftVapor3", "-i", "WithoutAuthTest/codegen_test.yml", "-o", "./target/test-classes/WithoutAuthTest/VaporTestInterface", "--additional-properties", "projectName=VaporTestInterface"});
    //The previous command runs in a thread. Wait about 4 seconds for the thread to finish
    //TODO: Make the previous command blocking
    Thread.sleep(4000L);
